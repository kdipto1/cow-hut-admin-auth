...
const loginUser = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const passwordMatch = yield user_model_1.User.isPasswordMatched(
      password,
    ...
    const accessToken = jwtHelpers_1.JwtHelpers.createToken(
      ...
      config_1.default.jwt.expiresIn
    );
    const refreshToken = jwtHelpers_1.JwtHelpers.createToken(
      { userId, role },
      config_1.default.jwt.refresh_secret,
      config_1.default.jwt.refresh_secret_expiresIn
    );
    return {
      accessToken,
      refreshToken,
...
const updateMyProfile = (payload, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = typeof payload === "string" ? payload : payload.userId;
    if (!userId) {
      throw new ApiError_1.default(
